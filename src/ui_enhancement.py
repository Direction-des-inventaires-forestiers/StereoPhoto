...
class Ui_enhanceWindow(object):
    def setupUi(self, enhanceWindow):
        ...
        self.groupBoxPicture.setGeometry(QtCore.QRect(20, 590, 120, 61))
        ...
        self.radioButtonPremiere.setGeometry(QtCore.QRect(10, 20, 120, 17))
        ...
        self.radioButtonDeuxieme.setGeometry(QtCore.QRect(10, 40, 120, 17))
