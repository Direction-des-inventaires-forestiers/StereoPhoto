...
class Ui_optionWindow(object):
    def setupUi(self, optionWindow):
        ...
        self.enhanceButton.setGeometry(QtCore.QRect(360, 340, 71, 23))
        ...
        self.affichageButton.setGeometry(QtCore.QRect(280, 340, 71, 23))
        ...
        self.groupBoxShape.setGeometry(QtCore.QRect(170, 450, 251, 261))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.drawButton.setGeometry(QtCore.QRect(10, 90, 111, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.cutButton.setGeometry(QtCore.QRect(130, 90, 111, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.radioButtonMerge.setGeometry(QtCore.QRect(45, 120, 121, 17))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.radioButtonAuto.setGeometry(QtCore.QRect(45, 140, 131, 17))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_11.setGeometry(QtCore.QRect(30, 230, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lineEditXClic.setGeometry(QtCore.QRect(120, 170, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lineEditYClic.setGeometry(QtCore.QRect(120, 200, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.lineEditZClic.setGeometry(QtCore.QRect(120, 230, 111, 20))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_12.setGeometry(QtCore.QRect(30, 200, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_13.setGeometry(QtCore.QRect(30, 170, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.pushButtonRemoveShape = QtWidgets.QPushButton(self.groupBoxShape)
        self.pushButtonRemoveShape.setGeometry(QtCore.QRect(140, 65, 101, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.panButton.setGeometry(QtCore.QRect(40, 450, 81, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_7.setGeometry(QtCore.QRect(10, 340, 91, 16))
        self.label_7.setObjectName("label_7")
        self.lineEditCurrentZ = QtWidgets.QLineEdit(optionWindow)
        self.lineEditCurrentZ.setGeometry(QtCore.QRect(105, 340, 81, 20))
        ...
        self.label_10.setGeometry(QtCore.QRect(10, 380, 141, 16))
        self.label_10.setObjectName("label_10")
        self.spinBoxRecouvrementH = QtWidgets.QSpinBox(optionWindow)
        self.spinBoxRecouvrementH.setGeometry(QtCore.QRect(140, 380, 51, 22))
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 480, 111, 101))
        self.groupBox.setObjectName("groupBox")
        self.radioPointLayer = QtWidgets.QRadioButton(self.groupBox)
        self.radioPointLayer.setEnabled(False)
        ...
        self.radioLineLayer.setEnabled(False)
        ...
        self.label_14.setGeometry(QtCore.QRect(200, 380, 171, 20))
        ...
        self.lineEditMNT.setEnabled(False)
        ...
        self.toolButtonMNT.setEnabled(False)
        ...
        self.groupBoxMoveLine.setGeometry(QtCore.QRect(20, 590, 141, 121))
        ...
        self.pushButtonReverseImage = QtWidgets.QPushButton(optionWindow)
        self.pushButtonReverseImage.setEnabled(False)
        self.pushButtonReverseImage.setGeometry(QtCore.QRect(195, 340, 75, 23))
        self.pushButtonReverseImage.setObjectName("pushButtonReverseImage")
        ...
        self.pushButtonReverseImage.raise_()
    ...
    def retranslateUi(self, optionWindow):
        ...
        self.pushButtonReverseImage.setText(_translate("optionWindow", "Inverser"))
