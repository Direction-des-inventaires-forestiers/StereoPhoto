...
class Ui_optionWindow(object):
    def setupUi(self, optionWindow):
        ...
        self.label_9.setGeometry(QtCore.QRect(180, 260, 101, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBoxSuper.setGeometry(QtCore.QRect(90, 280, 261, 142))
    ...
    def retranslateUi(self, optionWindow):
        ...
        self.boxOrientationRouge.setItemText(0, _translate("optionWindow", "0°"))
        self.boxOrientationRouge.setItemText(1, _translate("optionWindow", "90°"))
        self.boxOrientationRouge.setItemText(2, _translate("optionWindow", "180°"))
        self.boxOrientationRouge.setItemText(3, _translate("optionWindow", "270°"))
