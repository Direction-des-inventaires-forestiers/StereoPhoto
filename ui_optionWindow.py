...
class Ui_optionWindow(object):
    def setupUi(self, optionWindow):
        ...
        self.enhanceButton.setGeometry(QtCore.QRect(230, 320, 71, 23))
        ...
        self.affichageButton.setGeometry(QtCore.QRect(130, 320, 71, 23))
        self.affichageButton.setObjectName("affichageButton")
        self.groupBoxAfficher = QtWidgets.QGroupBox(optionWindow)
        self.groupBoxAfficher.setGeometry(QtCore.QRect(10, 350, 411, 161))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.groupBoxAfficher.setFont(font)
        self.groupBoxAfficher.setObjectName("groupBoxAfficher")
        self.importLineVectorLayer = QtWidgets.QLineEdit(self.groupBoxAfficher)
        self.importLineVectorLayer.setGeometry(QtCore.QRect(10, 40, 166, 20))
        ...
        self.importToolVectorLayer = QtWidgets.QToolButton(self.groupBoxAfficher)
        self.importToolVectorLayer.setGeometry(QtCore.QRect(175, 40, 25, 19))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.drawButton = QtWidgets.QPushButton(self.groupBoxAfficher)
        self.drawButton.setEnabled(False)
        self.drawButton.setGeometry(QtCore.QRect(10, 70, 91, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.offsetButton = QtWidgets.QPushButton(self.groupBoxAfficher)
        self.offsetButton.setEnabled(False)
        self.offsetButton.setGeometry(QtCore.QRect(330, 70, 61, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.panButton = QtWidgets.QPushButton(self.groupBoxAfficher)
        self.panButton.setEnabled(False)
        self.panButton.setGeometry(QtCore.QRect(250, 70, 61, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.cutButton = QtWidgets.QPushButton(self.groupBoxAfficher)
        self.cutButton.setEnabled(False)
        self.cutButton.setGeometry(QtCore.QRect(110, 70, 91, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.radioButtonMerge = QtWidgets.QRadioButton(self.groupBoxAfficher)
        ...
        self.radioButtonAuto = QtWidgets.QRadioButton(self.groupBoxAfficher)
        self.radioButtonAuto.setGeometry(QtCore.QRect(45, 130, 121, 17))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, optionWindow):
        ...
        self.groupBoxAfficher.setTitle(_translate("optionWindow", "Option d\'affichage"))
        self.importToolVectorLayer.setText(_translate("optionWindow", "..."))
        self.drawButton.setText(_translate("optionWindow", "Ajouter Polygon"))
        self.offsetButton.setText(_translate("optionWindow", "Offset"))
        self.panButton.setText(_translate("optionWindow", "Pan"))
        self.cutButton.setText(_translate("optionWindow", "Couper Polygon"))
        self.radioButtonMerge.setText(_translate("optionWindow", "Merge Polygon"))
        self.radioButtonAuto.setText(_translate("optionWindow", "Automatic Polygon"))
